// app/apply/page.tsx — Channel Partner application (public onboarding form)
// R19.5 (D-2): the developer/API application flow is retired — B-end tenants
// are created instantly via wallet self-service at /b. Channel applications
// (distribution / revenue share) still go through this form.
'use client'

import { useState } from 'react'
import { AppLayout } from '@/components/layout/AppLayout'
import { Check, Loader2, ArrowRight, Building2, User, Mail, Globe, MessageSquare, Wallet, Percent, Server, Zap } from 'lucide-react'
        ...
        <div className="max-w-md mx-auto py-24 px-6">
          <div className="glass-card p-10 text-center space-y-4">
            ...
            <p className="text-sm text-text-muted">
              Thank you! Your channel application <span className="font-mono text-text-primary">#{result.id}</span> has been submitted.
      ...
      <div className="max-w-2xl mx-auto py-10 px-6 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="body text-text-secondary max-w-lg mx-auto">
            Join the AgentX ecosystem as a distribution channel. Refer subscribers, earn a revenue share on every attributed
            subscription — transparently tracked on-chain.
          </p>
          <Link href="/b" className="text-sm text-accent-cyan inline-flex items-center gap-1.5 mt-3 hover:underline">
            Building your own integration instead? Self-serve at the Business console →
          </Link>
        </div>
